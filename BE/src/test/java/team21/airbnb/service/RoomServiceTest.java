...
class RoomServiceTest {
    ...
    public void setUp() {
        ...
        Room room = new Room(
                ...
                new RoomChargeInformation(82953, 25996, 4),
    ...
    public void searchRoom() throws Exception {
        ...
        RoomSearchCondition condition = new RoomSearchCondition(
                ...
                new GuestGroup(1, 1, 1)
                , new Location(130.0, 30.0)
                , new Location(120.0, 40.0));

        // when
        List<RoomSearchResponse> roomSearchResponses = roomService.searchRooms(condition);

        // then
        Assertions.assertThat(roomSearchResponses).hasSize(1);
    }
    ...
    public void getRoomChargeDistributionTest() {
        ...
        //         .name("room1")
        //         .roomChargeInfo(new RoomChargeInformation(300, 0, 0))
        //         .build();
        // Room room2 = Room.builder()
        //         .name("room2")
        //         .roomChargeInfo(new RoomChargeInformation(200, 0, 0))
        //         .build();
        // Room room3 = Room.builder()
        //         .name("room3")
        //         .roomChargeInfo(new RoomChargeInformation(100, 0, 0))
        //         .build();
        //
